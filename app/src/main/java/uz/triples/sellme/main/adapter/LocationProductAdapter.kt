...
class LocationProductAdapter :
    ListAdapter<ProductData, LocationProductAdapter.ProductViewHolder>(DiffItem) {
    ...
    fun setOnClickListener(fm: (Int) -> Unit) {
        listener = fm
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProductViewHolder =
        ProductViewHolder(
            LayoutInflater.from(parent.context).inflate(
                R.layout.location_item_product, parent, false
            )
        )
